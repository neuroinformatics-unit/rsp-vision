...
def check_how_many_sessions_in_dataset(folder_naming_specs: FolderNamingSpecs, n_days: int) -> None:
    ...
    for day_folder in day_folders:
        ...
        assert len(os.listdir(path / day_folder)) == 19, f"There should be 18 sessions in {day_folder}"
