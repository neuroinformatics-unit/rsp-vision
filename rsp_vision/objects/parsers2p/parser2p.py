...
class Parser2p(ABC):
    ...
    specific and tailor made to the folder structure in Winstor. When
    inheriting from this class, the method parse() must be implemented.
    ...
    def _parse(self) -> dict:
        ...
        `mouse_line`, `mouse_id`, `hemisphere`, `brain_region` and
        `monitor_position`.

        To be implemented by the child classes taking into account the folder
    ...
    def get_path_to_experimental_folder(self) -> Path:
        """Returns the path to the file containing the suite2p output.
    ...
    def get_path_to_allen_dff_file(self) -> Path:
        """Returns the path to the file containing the allen dff.
    ...
    def get_path_to_serial2p(self) -> Path:
        """Returns the path to the file containing the serial2p output.
    ...
    def _minimum_params_required(self) -> bool:
        """Checks if the minimum parameters have been evaluated by the
        parser.
